...
const canciones = [
    ...
    "3 Vallejo - Pepito El Dragon.mp3",
    "Angelica Infante-Rolando sobre ruedas.mp3",
    "Charly Montana - Como Las Hojas.mp3",
    "Sam Sam - El preso No 10.mp3",
    "El Rolas - Yo Sin Ti.mp3",
    "Jose Luis DF - Sabes Que Paso.mp3",
    "Juan Hernandez - Poeta De Ningun Lugar.mp3",
    "Liran Roll - Es Mi Vida.mp3",
    "Banda Bostik - Dejala Ser.mp3",
    "Charlie Monttana - Es Que Te Amo.mp3",
    "Rod Levario - Avientense Todos.mp3",
    "Tatuaje Vivo - Flores De Muerto.mp3",
    "Liran Roll - Ninos De La Calle.mp3",
    "El tri - Que Viva El Rockanroll.mp3",
    "Tex Tex - Toque Magico.mp3",
    "Toma II - Tengo Que.mp3",
    "Jose Luis DF - Ciudad Corrupta.mp3",
    "Especimen - Perdon Por Nacer.mp3",
    "El Haragan - Juan El Descuartizador.mp3",
    "La Otra Cara De Mexico - Viviras En Mi.mp3",
    "El Haragan - En Los Años 30.mp3",
    "Heavy Nopal - Asalto Chido.mp3",
    "Luzbel - El Loco.mp3",
    "Interpuesto - Otra Cancion.mp3",
    "Hazel - El Ultimo Jalon.mp3",
